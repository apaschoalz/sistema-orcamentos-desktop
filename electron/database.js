...
class AppDatabase {
    ...
    saveItensOrcamento(orcamentoId, itens) {
        ...
        // 6. Atualizar valor total do orçamento
        ...
        // OBS: O push dos itens para o Supabase é feito pelo main.js via
        // supabaseSync.pushBatchItens() — em batch, com await, mais confiável.
